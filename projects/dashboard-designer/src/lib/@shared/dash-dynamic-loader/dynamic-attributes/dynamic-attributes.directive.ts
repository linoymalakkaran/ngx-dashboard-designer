...
@Directive({
  selector: '[dashDynamicAttributes],[ngComponentOutletDashDynamicAttributes]',
  exportAs: 'dashDynamicAttributes'
})
export class DashAttributesDirective implements DoCheck {
  @Input()
  dashDynamicAttributes: AttributesMap;
  @Input()
  ngComponentOutletDashDynamicAttributes: AttributesMap;
  ...
  private get _attributes() {
    return (
      this.dashDynamicAttributes || this.ngComponentOutletDashDynamicAttributes
    );
  }
