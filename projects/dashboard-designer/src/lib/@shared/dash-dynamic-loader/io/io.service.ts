...
import { DashComponentInjector } from '../component-injector';
...
export class IoService implements OnDestroy {
  ...
  private compInjector: DashComponentInjector;
  ...
  init(componentInjector: DashComponentInjector, options: IoInitOptions = {}) {
