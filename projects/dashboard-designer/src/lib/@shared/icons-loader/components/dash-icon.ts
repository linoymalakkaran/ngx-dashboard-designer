 ...
 * @docs-private
 */
export const DASH_ICON_LOCATION = new InjectionToken<DashIconLocation>(
  'dash-icon-location',
  {
    providedIn: 'root',
    factory: DASH_ICON_LOCATION_FACTORY
  }
);

/**
 * Stubbed out location for `DashIcon`.
 * @docs-private
 */
export interface DashIconLocation {
  getPathname: () => string;
}

// /** @docs-private */
export function DASH_ICON_LOCATION_FACTORY(): DashIconLocation {
...
export class DashIcon implements OnInit, AfterViewChecked, OnDestroy {
  /**
  ...
  constructor(
    ...
    @Inject(DASH_ICON_LOCATION) private _location: DashIconLocation,
